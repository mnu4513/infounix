...
const Newsletter = () => {
  ...
  return (
    <section
      id="newsletter"
      className="bg-slate-950 pb-16 pt-6 text-slate-50"
    >
      <div className="mx-auto max-w-6xl px-4 md:px-6 lg:px-8">
        <div className="grid gap-6 rounded-3xl border border-sky-500/40 bg-gradient-to-r from-slate-950 via-slate-900/80 to-slate-950 p-6 shadow-2xl shadow-sky-500/30 backdrop-blur md:grid-cols-[1.6fr,1fr] md:p-8">
          <div className="space-y-3">
            ...
            >
              <input
                ...
                className="h-10 flex-1 rounded-full border border-slate-600 bg-slate-900/60 px-4 text-xs text-slate-100 outline-none ring-sky-500/40 placeholder:text-slate-500 focus:border-sky-500 focus:ring-1"
              />
              <button
                type="submit"
          ...
          <div className="space-y-3 text-xs text-slate-200">
            <p className="font-semibold text-sky-200">Need help?</p>
            <p>
