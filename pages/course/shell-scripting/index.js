// pages/course/shell-scripting/index.js

import React from "react";
import Head from "next/head";
import ShellLayout from "../../../components/shell/ShellLayout";

export default function ShellOverviewPage() {
  return (
    <>
      <Head>
        <title>Shell Scripting Course | InfoUnix</title>
        <meta
          name="description"
          content="Learn essential skills and techniques for efficiently managing Solaris 11 systems with this Shell Scripting Course."
        />
      </Head>
